...
{
    Value *newValue, *currentValue = ValueCreator::createValue(Scopes::get(variable));
    switch (currentValue->getType())
    {
    case Type::Int8: 
        newValue = new I8Value(currentValue->i8Get() + 1);
        break;

    case Type::Int16: 
        newValue = new I16Value(currentValue->i16Get() + 1);
        break;

    case Type::Int32: 
        newValue = new I32Value(currentValue->i32Get() + 1);
        break;

    case Type::Int64: 
        newValue = new I64Value(currentValue->i64Get() + 1);
        break;

    case Type::UInt8: 
        newValue = new UI8Value(currentValue->ui8Get() + 1);
        break;

    case Type::UInt16: 
        newValue = new UI16Value(currentValue->ui16Get() + 1);
        break;

    case Type::UInt32: 
        newValue = new UI32Value(currentValue->ui32Get() + 1);
        break;

    case Type::UInt64: 
        newValue = new UI64Value(currentValue->ui64Get() + 1);
        break;

    case Type::Int: 
        newValue = new IValue(currentValue->iGet() + 1);
        break;

    case Type::Float32: 
        newValue = new F32Value(currentValue->f32Get() + 1);
        break;

    case Type::Float64: 
        newValue = new F64Value(currentValue->f64Get() + 1);
        break;

    case Type::Float80: 
        newValue = new F80Value(currentValue->f80Get() + 1);
        break;

    case Type::Var: 
        newValue = new VarValue(currentValue->varGet() + 1);
        break;
