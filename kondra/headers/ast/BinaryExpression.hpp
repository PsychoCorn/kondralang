...
Value *BinaryExpression::add()
{
    ...
    case Int8:
        ...
        case Ref: return new RefValue(operand1->i8Get() + operand2->refGet(), true);
    ...
    case Int16:
        ...
        case Ref: return new RefValue(operand1->i16Get() + operand2->refGet(), true);
    ...
    case Int32:
        ...
        case Ref: return new RefValue(operand1->i32Get() + operand2->refGet(), true);
    ...
    case Int64:
        ...
        case Ref: return new RefValue(operand1->i64Get() + operand2->refGet(), true);
    ...
    case UInt8:
        ...
        case Ref: return new RefValue(operand1->ui8Get() + operand2->refGet(), true);
    ...
    case UInt16:
        ...
        case Ref: return new RefValue(operand1->ui16Get() + operand2->refGet(), true);
    ...
    case UInt32:
        ...
        case Ref: return new RefValue(operand1->ui32Get() + operand2->refGet(), true);
    ...
    case UInt64:
        ...
        case Ref: return new RefValue(operand1->ui64Get() + operand2->refGet(), true);
    ...
    case Ref:
        switch (operand2->getType())
        {
        case Int8: return new RefValue(operand1->refGet() + operand2->i8Get(), true);
        case Int16: return new RefValue(operand1->refGet() + operand2->i16Get(), true);
        case Int32: return new RefValue(operand1->refGet() + operand2->i32Get(), true);
        case Int64: return new RefValue(operand1->refGet() + operand2->i64Get(), true);
        case UInt8: return new RefValue(operand1->refGet() + operand2->ui8Get(), true);
        case UInt16: return new RefValue(operand1->refGet() + operand2->ui16Get(), true);
        case UInt32: return new RefValue(operand1->refGet() + operand2->ui32Get(), true);
        case UInt64: return new RefValue(operand1->refGet() + operand2->ui64Get(), true);
        case Int: return new RefValue(operand1->refGet() + operand2->i64Get(), true);
        case Bool: return new RefValue(operand1->refGet() + operand2->bGet(), true);
        case Var: return new VarValue(operand1->refGet() + operand2->i64Get(), true);
        default: throw std::runtime_error(ERR_MSG_WRNG_OPNDS);
        }
    ...
    case Bool:
        ...
        case Ref: return new RefValue(operand1->bGet() + operand2->refGet(), true);
    ...
    case Var:
        ...
        case Ref: return new VarValue(operand1->varGet() + operand2->refGet(), true);
...
Value *BinaryExpression::sub()
{
    ...
    case Ref:
        ...
        case Int: return new RefValue(operand1->refGet() - operand2->i64Get(), true);
        case Bool: return new RefValue(operand1->refGet() - operand2->bGet(), true);
        case Var: return new VarValue(operand1->refGet() - operand2->varGet(), true);
        default: throw std::runtime_error(ERR_MSG_WRNG_OPNDS);
        }
