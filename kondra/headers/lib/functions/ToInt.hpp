...
{
    return new IValue(static_cast<kondra::dynamic_int>(0), true);
}
...
{
    return new IValue(static_cast<kondra::dynamic_int>((*begin)->varGet()), true);
}
...
{
    return new IValue(kondra::dynamic_int((*begin)->strGet(), (*(begin + 1))->ui64Get()), true);
}
