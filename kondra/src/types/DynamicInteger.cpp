...
namespace kondra
{
    ...
    DynamicInteger::DynamicInteger(const int8_t &intValue)
    {
        mpz_init_set_si(value, intValue);
    }

    DynamicInteger::DynamicInteger(const uint8_t &intValue)
    {
        mpz_init_set_ui(value, intValue);
    }

    DynamicInteger::DynamicInteger(const int16_t &intValue)
    {
        mpz_init_set_si(value, intValue);
    }

    DynamicInteger::DynamicInteger(const uint16_t &intValue)
    {
        mpz_init_set_ui(value, intValue);
    }

    DynamicInteger::DynamicInteger(const int32_t &intValue)
    {
        mpz_init_set_si(value, intValue);
    }

    DynamicInteger::DynamicInteger(const uint32_t &intValue)
    {
        mpz_init_set_ui(value, intValue);
    }

    DynamicInteger::DynamicInteger(const int64_t &intValue)
    {
        mpz_init_set_si(value, intValue);
    }

    DynamicInteger::DynamicInteger(const uint64_t &intValue)
    {
        mpz_init_set_ui(value, intValue);
    }
    ...
    int64_t DynamicInteger::longLongGetNumber() const
    {
        return mpz_get_si(value);
    }

    uint64_t DynamicInteger::uLongLongGetNumber() const
    {
    ...
    DynamicInteger DynamicInteger::operator++(int32_t)
    {
