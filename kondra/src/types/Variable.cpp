...
namespace kondra
{
    ...
    Variable::Variable(const int8_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }
    
    Variable::Variable(const uint8_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }

    Variable::Variable(const int16_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }
    
    Variable::Variable(const uint16_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }

    Variable::Variable(const int32_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }

    Variable::Variable(const uint32_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }

    Variable::Variable(const int64_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }

    Variable::Variable(const uint64_t &intValue)
    {
        data.intData = new dynamic_int(intValue);
        type = VarType::Int;
    }
    ...
    Variable Variable::toInt(const Variable &obj)
    {
        ...
        case VarType::Bool:
            return Variable(int32_t(*(obj.getData().boolData)));
            break;
    ...
    Variable Variable::operator++(int32_t)
    {
        Variable temp = *this;
        *this = *this + Variable(1);
        return temp;
